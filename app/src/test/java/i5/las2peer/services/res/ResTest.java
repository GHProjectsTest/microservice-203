...
public class ResTest {
  ...
  /**
   * 
   * Test for the TestCase1_ID267301 method.
   * 
   */
  @Test
  public void testTestCase1_ID2673012() {
...
""");
  ...
  /**
   * 
   * Test for the TestCase2_ID986527 method.
   * 
   */
  @Test
  public void testTestCase2_ID9865272() {
    MiniClient c = new MiniClient();
    c.setConnectorEndpoint(connector.getHttpEndpoint());
    ...
    try {
      c.setLogin(AnonymousAgentImpl.IDENTIFIER, "");
      ClientResponse result = c.sendRequest("GET", mainPath + "/fail", """
""");
    
      Assert.assertEquals("[757328]", result.getHttpCode(), 200);
